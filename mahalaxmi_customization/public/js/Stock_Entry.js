...
// ============================================================
// STOCK ENTRY — COMBINED SCRIPT
// Script 1: Packaging / FG Cost Distribution
// Script 2: Manufacture / Grinding Loss Calculation
// ============================================================
...
//     // Refresh par calculation mat chalao
//     // update_process_loss(frm);
//     // calculate_all(frm);
...
//             if (row.item_code) {
//                 return frappe.db
//                     .get_value("Item", row.item_code, "custom_is_byproduct_item")
//                     .then(function (r) {
//                         if (r && r.message) {
//                             return frappe.model.set_value(
//                                 row.doctype,
...
//         (frm.doc.items || []).forEach(function (row) {
//             // 🔒 LOCK — skip packaging material rows
...
//         calculate_process_loss_packaging(frm);
...
//         // Fetch latest batch for this item
//         let row = locals[cdt][cdn];
//         if (row.item_code) {
//             frappe.call({
...
// // ============================================================
// // CALCULATE ALL — Main dispatcher
// // Packaging logic always runs; Manufacture logic only when type = Manufacture
// // ============================================================

// function calculate_all(frm) {
//     // --- Packaging / FG cost distribution (runs always) ---
//     calculate_fg_total(frm);
//     calculate_process_loss_packaging(frm);
//     calculate_distribution(frm);

//     // --- Manufacture / Grinding loss (only for Manufacture entries) ---
//     if (frm.doc.stock_entry_type !== 'Manufacture') return;
//     set_production_quantity(frm);
//     set_byproduct_input(frm);
//     set_byproduct_output(frm);
...
// // ============================================================
// // PACKAGING — FG Total & Process Loss
// // ============================================================
...
// function calculate_process_loss_packaging(frm) {
...
// // ============================================================
// // MANUFACTURE — Process Loss (fg_completed_qty freeze)
// // ============================================================
...
//     let process_loss = fg_qty - finished_qty;
//     let loss_percentage = fg_qty > 0
//         ? (process_loss / fg_qty) * 100
//         : 0;

//     if (flt(frm.doc.process_loss_qty) !== flt(process_loss, 3)) {
//         frm.doc.process_loss_qty = flt(process_loss, 3);
//         frm.refresh_field('process_loss_qty');
//     }

//     if (flt(frm.doc.process_loss_percentage) !== flt(loss_percentage, 2)) {
//         frm.doc.process_loss_percentage = flt(loss_percentage, 2);
//         frm.refresh_field('process_loss_percentage');
//     }
// }
...
// // ============================================================
// // MANUFACTURE — Production Quantity
// // ============================================================
...
// // ============================================================
// // MANUFACTURE — Finished Goods Quantity
// // ============================================================
...
// // ============================================================
// // MANUFACTURE — Total Material Consumption
// // ============================================================
